...
const initGame = () => {
    ...
    if(snakeX === foodX && snakeY === foodY){
        ...
        if (score === 5) {
            clearInterval(setIntervalId);
            setIntervalId = setInterval(initGame, 80); // ajuste l'intervalle pour accélérer le jeu
        } else if (score === 10) {
            clearInterval(setIntervalId);
            setIntervalId = setInterval(initGame, 65); // ajuste l'intervalle pour accélérer le jeu davantage
        } else if (score === 15) {
            clearInterval(setIntervalId);
            setIntervalId = setInterval(initGame, 55); // ajuste l'intervalle pour accélérer le jeu davantage
        }
